...
/**
 * Tests cutAndSplice in the ArrayListDNAStrand class
 */

public class ArrayListDNAStrandTest {
		...
		*/
		String TestCase(int TestCaseNumber, String testString, String enzyme, String replacement)
		{
			...
			ArrayListDNAStrand s = new ArrayListDNAStrand (TestString);
		...
		/** Test Cases
		 * testcutAndSplice tests the cutAndSplice function in the ArrayListDNAStrand Class
		 * 
