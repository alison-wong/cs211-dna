...
public class LinkedListDNAStrandTest {
	...
	*/
	...
	String TestCase(int TestCaseNumber, String testString, String enzyme, String replacement)
	{
		...
		LinkedListDNAStrand s = new LinkedListDNAStrand (TestString);
	...
	/** Test Cases
	 * testcutAndSplice tests the cutAndSplice function in the LinkedListDNAStrand Class
	 * 
